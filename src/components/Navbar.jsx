...
const Navbar = () => {
    ...
    <nav className={`fixed w-full left-0 top-0 z-[999] ${sticky ? "bg-white/60 text-gray-900" : "text-gray-200"}`}>
            ...
            <ul className="flex items-center text-black gap-1 py-2 text-lg">
              {
                ...
                <li key={`${menu.name} ${Date.now()}`} className="px-7 font-bold text-base hover:text-gray-200" >
